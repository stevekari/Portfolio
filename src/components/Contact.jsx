          ...
          >
            ...
            <div className="contact-list">
              ...
              <a
                ...
                aria-label="Direct WhatsApp Chat with Stephen Karikari (+34 603 107 613)"
              >
                ...
                <div className="contact-item-details">
                  <span className="contact-item-label">WHATSAPP / PHONE</span>
                  <span className="contact-item-value">+34 603 107 613 (Instant Chat)</span>
                </div>
              </a>
